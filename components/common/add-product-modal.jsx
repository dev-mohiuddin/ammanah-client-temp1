...
function AddProductModal({ product }) {
  ...
  return (
    <div className="flex h-full p-5 rounded-md w-[1000px] mx-auto text-white overflow-auto">
      <div className="w-full  flex flex-col ">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {["V", "VG", "GF", "HOT", "MEDIUM", "VERY HOT", "MILD"].map((tag) => (
            <span key={tag} className="bg-gray-600 text-xs px-2 py-1 rounded">
              {tag}
            </span>
          ))}
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div>
            ...
            <ToggleGroup
              ...
              onValueChange={(value) => value && setSelectedAllergenId(value)}
              className="justify-start gap-4"
            >
        ...
        <div className="mt-auto pt-6 flex flex-col gap-4">
          <div className="flex gap-2">
            <Button className="flex-1 bg-red-600 hover:bg-red-700">No</Button>
      ...
      <div className="w-1/3">
        <div className="flex flex-col gap-4 text-sm">
          <div>
            <h4 className="text-yellow-500 font-bold mb-1">Size Variant</h4>
            <p>
          ...
          {selectedIngredients.length > 0 && (
            <div>
              <h4 className="text-yellow-500 font-bold mb-1">Ingredients</h4>
            ...
            <div>
              ...
              {selectedAddOns.map((addon) => (
                <div key={addon.id} className="flex justify-between">
                  ...
                  {addon.price > 0 && <span>+ {addon.price.toFixed(2)}</span>}
                </div>
              ))}
            </div>
          )}
